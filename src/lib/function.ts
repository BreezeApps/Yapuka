...
// import { getTranslation, getTranslationWithVar } from "./i18n";
...
// export function activeButton(id: string) {
...
// }
// export function deactiveButton(id: string) {
//   const button = document.getElementById(id);
...
// export async function changeTab(tabid: string) {
